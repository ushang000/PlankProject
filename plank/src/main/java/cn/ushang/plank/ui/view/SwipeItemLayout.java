        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:{
                    ...
                    Log.i("shao","pointView : "+pointView.getTag());
                    //||pointView.getTag(position).equals("official")
                    if(pointView==null || !(pointView instanceof SwipeItemLayout)||(int)pointView.getTag()==6){
